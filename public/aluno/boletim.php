...
require_once __DIR__ . '/../../api/responsavel/boletim.php';
...
$provas = listProvasENotasDoAluno($usuarioId);
$media  = mediaNotasDoAluno($usuarioId);
      ...
      <div class="row g-3">
        ...
        <div class="col-12 d-flex align-items-center justify-content-between">
          ...
          <span class="text-muted small">
            Logado como: <?= htmlspecialchars($usuarioNome) ?> (#<?= htmlspecialchars($usuarioId) ?>)
          </span>
        </div>
        ...
        <div class="col-12 col-lg-4">
          <div class="card">
            <div class="card-body">
              ...
              <div class="text-muted small">Somente provas avaliadas entram no cálculo.</div>
            </div>
          </div>
        </div>
        ...
        <div class="col-12 col-lg-8">
          <div class="card">
            <div class="card-body">
              ...
              <?php if (empty($provas)): ?>
                <div class="alert alert-secondary mb-0">Nenhuma prova cadastrada até o momento.</div>
              <?php else: ?>
                      ...
                      <?php foreach ($provas as $prova): ?>
                        ...
                        <tr>
                          ...
                          <td>
                            ...
                            <span class="text-muted">(#<?= (int)$prova['prova_id'] ?>)</span>
                          </td>
                          <td><?= $nota !== null ? number_format($nota, 2, ',', '') : '—' ?></td>
                          <td>
                            <span class="badge text-bg-<?= $sitColor ?>"><?= $sitLabel ?></span>
                          </td>
                        </tr>
                      <?php endforeach; ?>
